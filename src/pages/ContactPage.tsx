...
export const ContactPage: React.FC = () => {
  return (
    <div className="bg-alabaster min-h-screen">
      ...
      <div className="bg-linen border-b border-craftBorder py-8 px-6 sm:px-12 md:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          <nav className="flex items-center space-x-2 text-[10px] font-mono uppercase tracking-widest text-obsidian/60 mb-6">
            ...
            <span>/</span>
            <span className="text-obsidian font-semibold">Contact & Ateliers</span>
            <span>/</span>
            <span className="text-terracotta">Bhadohi Factory & Showroom</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
            <div className="lg:col-span-8">
              ...
              <h1 className="font-serif text-3xl sm:text-5xl lg:text-6xl text-obsidian uppercase tracking-tight font-normal leading-tight">
                ...
                <span className="italic font-light text-terracotta">EXPERIENCE THE CRAFT FIRSTHAND.</span>
              </h1>
            </div>

            <div className="lg:col-span-4 space-y-3 text-xs text-obsidian/80 font-sans leading-relaxed">
              <p>
                We warmly welcome interior designers, collectors, and architectural teams to tour our Maryadpatti looms and examine over 500 hand-knotted samples at our Carpet City gallery.
              </p>
              <div className="flex items-center space-x-3 pt-2">
                <a
                  href="https://wa.me/917317076787?text=Hello%20Naman%20Rugs,%20I%20would%20like%20to%20schedule%20a%20private%20visit%20to%20your%20Carpet%20City%20showroom."
                  target="_blank"
      ...
      {/* Industrial Dossier Component */}
      <IndustrialDossier />

      {/* Virtual Loom Tour Option */}
      <VirtualLoomTour />
    </div>
  );
};
