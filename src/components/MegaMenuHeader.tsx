      ...
      <div className="bg-obsidian text-alabaster px-6 sm:px-12 py-1.5 text-[10px] font-mono tracking-widest flex items-center justify-between border-b border-white/10">
        ...
        <div className="flex items-center space-x-6">
          ...
          >
            ...
            <span>WhatsApp Specifier Line: +91 7317076787</span>
          </a>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 py-4 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center space-x-7 text-xs font-mono tracking-widest uppercase text-obsidian/80">
          ...
          >
            ...
            {activeMegaMenu === "shop" && (
              <div className="absolute top-full left-1/2 -translate-x-1/2 w-[820px] bg-alabaster border border-craftBorder shadow-luxury-elevated p-8 animate-in fade-in slide-in-from-top-2 duration-200 grid grid-cols-4 gap-8">
          ...
          <button onClick={() => handleLink("collections", "/collections")} className="hover:text-terracotta transition-colors">
            Collections
          </button>

          {/* Size Guide Subpage */}
          <button onClick={() => handleLink("size-guide", "/size-guide")} className="hover:text-terracotta transition-colors">
            Size Visualizer
          </button>

          {/* Manchaha Subpage */}
          <button onClick={() => handleLink("manchaha", "/manchaha")} className="hover:text-terracotta transition-colors">
            Manchaha
          </button>

          {/* Care & Wash Subpage */}
          <button onClick={() => handleLink("services", "/services")} className="hover:text-terracotta transition-colors">
            Care & Wash
          </button>

          {/* Trade Subpage */}
          <button onClick={() => handleLink("trade", "/trade")} className="hover:text-terracotta transition-colors">
            Trade
          </button>

          {/* Heritage Subpage */}
          <button onClick={() => handleLink("heritage", "/about")} className="hover:text-terracotta transition-colors">
            Heritage
          </button>

          {/* Contact Subpage */}
          <button onClick={() => handleLink("dossier", "/contact")} className="hover:text-terracotta transition-colors">
            Contact
          </button>
        </nav>
        ...
        <div className="flex items-center space-x-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden md:flex items-center space-x-1.5 px-3.5 py-1.5 bg-[#25D366] hover:bg-[#20ba5a] text-white text-xs font-mono tracking-wider uppercase transition-colors shadow-sm"
          >
